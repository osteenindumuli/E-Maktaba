...
// Fetch the category details to confirm it exists
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($delete_stmt->execute()) {
        ...
        $error_message = "Failed to delete the category. Please try again.";
...
<body>
    ...
    <div class="container">
        ...
        <form action="delete-category.php?id=<?= htmlspecialchars($category_id); ?>" method="post" class="shadow p-4 rounded mt-5" style="width: 90%; max-width:50rem;">
            <h1 class="text-center pb-5 display-4 fs-3">Delete Category</h1>
