...
// Fetch the author details to confirm it exists
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $delete_stmt = $conn->prepare("DELETE FROM author WHERE id = ?");
    $delete_stmt->bind_param("i", $author_id);
    ...
    if ($delete_stmt->execute()) {
        ...
        $error_message = "Failed to delete the author. Please try again.";
...
<body>
    ...
    <div class="container">
        ...
        <form action="delete-author.php?id=<?= htmlspecialchars($author_id); ?>" method="post" class="shadow p-4 rounded mt-5" style="width: 90%; max-width:50rem;">
            <h1 class="text-center pb-5 display-4 fs-3">Delete Author</h1>

            <p>Are you sure you want to delete the author <strong><?= htmlspecialchars($author['name']); ?></strong>?</p>
